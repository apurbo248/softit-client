      ...
      .then((data) => {
        if (data) {
          Swal.fire({
            ...
            if (result) {
              const remainCategory = categoryList.filter(
                (category) => category._id !== id
              );
              setCategoryList(remainCategory);
            }
          });
        }
      });
    ...
    <div>
      ...
      <div className="    md:px-6 md:ml-4   mt-20  ">
        <div className="flex justify-between">
          <h3 className="text-xl font-bold pl-4">Category</h3>
          <div>
            <div>
              <button
                type="button"
                      ...
                      categoryList.map((category, key) => (
                        ...
                        >
                          ...
                          <td className=" flex text-center pt-4">
                            <Link to={`/admin/category_update/${category._id}`}>
                            ...
                            <button
                              onClick={() =>
                                deleteUserHandler(category && category._id)
                              }
